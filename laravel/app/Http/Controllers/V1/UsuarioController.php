...
class UsuarioController extends Controller
{
    ...
    public function index()
    {
        ...
        $objeto=$this->model::with(['campanna', 'municipio'])->get();
       if($objeto){
    ...
    public function store(Request $request)
    {
        ...
        'password', 'rol', 'campanna', 'municipio_id');
    ...
    {
       //Bucamos el producto
       $objeto = $this->model::with(['campanna', 'municipio'])->find($id);
