...
class CampannaController extends Controller
{
    ...
    public function index()
    {
       ...
       $objeto=$this->model::with('municipio')->get();
       if($objeto){
    ...
    {
        //Validamos los datos
        $data = $request->only('municipio', 'user', 'descripcion',
        'corporacion', 'partido', 'logo', 'api');
        $validator = Validator::make($data, [
            'municipio' => 'required|numeric',
            'user' => 'required|numeric',
            'descripcion' => 'required|max:200|string',
            'corporacion' => 'required|max:200|string',
            'partido' => 'required|max:200|string',
            'api' => 'required|max:200|string'
        ]);
